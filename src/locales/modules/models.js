...
export default {
  ...
  contextLength: _('原生上下文窗口（选填）', 'Native Context Window (optional)', '原生上下文視窗（選填）', 'ネイティブコンテキスト長'),
  ...
  contextTokensLabel: _('运行时上下文上限（选填）', 'Runtime Context Cap (optional)', '運行時上下文上限（選填）'),
  contextTokensPlaceholder: _('如 50000；留空跟随模型窗口', 'e.g. 50000; leave empty to follow the model window', '如 50000；留空跟隨模型視窗'),
  contextTokensHint: _('OpenClaw 实际会话预算；设置后会同步到 Agent 运行时注册表', 'OpenClaw runtime conversation budget; synced to the Agent runtime registry', 'OpenClaw 實際會話預算；設定後會同步到 Agent 執行時註冊表'),
  ...
  contextLengthLabel: _('原生上下文窗口', 'Native Context Window', '原生上下文視窗'),
