...
export default {
  ...
  gatewayDiagnosticsDiagnosis: _('【问题判断】', '[Diagnosis]'),
  gatewayDiagnosticsMissingDependency: _('OpenClaw 安装不完整：缺少运行依赖 {dependency}。通常由升级中断、镜像同步或 npm 缓存异常造成。', 'The OpenClaw installation is incomplete: runtime dependency {dependency} is missing. This is commonly caused by an interrupted upgrade, registry sync, or npm cache issue.'),
  gatewayDiagnosticsRepair: _('一键修复 OpenClaw', 'Repair OpenClaw'),
  gatewayDiagnosticsRepairConfirm: _('将强制重装当前稳定版 OpenClaw，并在运行依赖校验通过后重新启动 Gateway。现有配置会保留。\n\n缺失依赖：{dependency}\n\n现在修复吗？', 'ClawPanel will force-reinstall the current stable OpenClaw build, verify runtime dependencies, and restart the Gateway. Existing configuration will be preserved.\n\nMissing dependency: {dependency}\n\nRepair now?'),
  gatewayDiagnosticsRepairTitle: _('修复 OpenClaw 运行环境', 'Repair OpenClaw runtime'),
  gatewayDiagnosticsRepairStarting: _('检测到缺失依赖 {dependency}，正在强制重装并校验完整性…', 'Missing dependency {dependency} detected. Force-reinstalling and verifying integrity…'),
  gatewayDiagnosticsRepairDone: _('OpenClaw 运行环境修复完成', 'OpenClaw runtime repaired'),
  gatewayDiagnosticsRepairFailed: _('OpenClaw 修复失败', 'OpenClaw repair failed'),
  gatewayDiagnosticsRestarting: _('运行依赖校验通过，正在重新启动 Gateway…', 'Runtime dependency verification passed. Restarting the Gateway…'),
  gatewayDiagnosticsRestarted: _('Gateway 已重新启动。', 'The Gateway has restarted.'),
  gatewayDiagnosticsRepairInstalledButStartFailed: _('OpenClaw 已完成重装和依赖校验，但 Gateway 重新启动失败', 'OpenClaw was reinstalled and its dependencies were verified, but the Gateway failed to restart'),
