# CJGClaw Chat + Setup Wizard Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Implement the real-time chat page with WebSocket streaming, Markdown rendering, and the first-run setup wizard. These are the most complex pages — chat is a rewrite of the 2534-line vanilla JS chat.js, and setup is a new first-run experience.

**Architecture:**
- Chat: React component with WebSocket hook, message list with streaming, Markdown renderer, tool event display, session management
- Setup: Multi-step wizard with Framer Motion transitions, sandbox init check, environment detection

**Tech Stack:** React 19, TypeScript, TanStack Query v5, Framer Motion v11, marked (Markdown), WebSocket (native)

---

### Task 1: WebSocket Client (lib/ws.ts)

**Files:**
- Modify: `src/lib/ws.ts` (replace stub from Plan 1)

- [ ] **Step 1: Implement full WebSocket client**

```typescript
// src/lib/ws.ts
// Replaces the stub from Plan 1. Mirrors the original ws-client.js logic
// (667 lines vanilla JS → ~300 lines TypeScript with proper types).
...
### Task 2: Chat Page — Core Layout and Message List

**Files:**
- Modify: `src/pages/chat/ChatPage.tsx`
- Create: `src/pages/chat/components/MessageList.tsx`
- Create: `src/pages/chat/components/ChatInput.tsx`
- Create: `src/pages/chat/components/SessionSidebar.tsx`

- [ ] **Step 1: Implement ChatPage.tsx**
...
### Task 3: Setup Wizard Page

**Files:**
- Modify: `src/pages/setup/SetupPage.tsx`
- Create: `src/pages/setup/components/WizardStep.tsx`
- Create: `src/pages/setup/components/SandboxInitStep.tsx`
- Create: `src/pages/setup/components/WelcomeStep.tsx`
- Create: `src/pages/setup/components/CompleteStep.tsx`

- [ ] **Step 1: Implement SetupPage.tsx**
...
- [ ] **Step 2: Create WelcomeStep component**
...
- [ ] **Step 3: Create SandboxInitStep component**
...
- [ ] **Step 4: Create CompleteStep component**
...
### Task 4: Add Markdown Renderer Utility
...
Install dependency: `npm install marked`
...
|------|-------|-------------|
| 1 | src/lib/ws.ts | Full WebSocket client with auto-reconnect, heartbeat, event handlers |
| 2 | ChatPage + MessageList + ChatInput | Chat UI with streaming messages and Markdown |
| 3 | SetupPage + 4 step components | Multi-step wizard with Framer Motion transitions |
| 4 | src/lib/markdown.ts | Markdown rendering utility |

After all 4 plans are complete, CJGClaw v1.0 is fully implemented.